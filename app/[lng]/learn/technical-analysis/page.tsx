    ...
    sections: {
      1: {
        ...
        types: {
          ...
          line: {
            title: "Line Charts",
            desc: "Simple price over time. Good for beginners.",
            best: "✓ Best for: Trend spotting",
          },
          candle: {
            title: "Candlestick Charts",
            desc: "Shows OHLC (Open, High, Low, Close)",
            best: "✓ Best for: Pattern recognition",
          },
          heikin: {
            title: "Heikin-Ashi",
            desc: "Smoothed candlesticks, less noise",
            best: "✓ Best for: Trend confirmation",
          },
        },
        candles: {
          title: "Understanding Candlesticks",
          bull: {
            title: "Bullish Candle (Green)",
            list: ["Close > Open", "Buyers in control", "Price moved up"],
          },
          bear: {
            title: "Bearish Candle (Red)",
            list: ["Close < Open", "Sellers in control", "Price moved down"],
          },
        },
        timeframes: {
          title: "Timeframes",
      ...
      2: {
        ...
        sr: {
          sup: {
            title: "📈 Support",
            desc: "Price level where buying interest prevents further decline",
            list: [
              'Acts as a "floor"',
              "Buyers step in",
              "If broken, becomes resistance",
              "Ex: BTC bouncing at $30k",
            ],
          },
          res: {
            title: "📉 Resistance",
            desc: "Price level where selling pressure prevents further rise",
            list: [
              'Acts as a "ceiling"',
              "Sellers step in",
              "If broken, becomes support",
              "Ex: ETH rejected at $2k",
            ],
          },
        },
        trends: {
          ...
          up: {
            ...
            desc: "Draw line connecting rising lows. Stay long above the line.",
          },
          down: {
            title: "Downtrend (Lower Highs, Lower Lows)",
            desc: "Draw line connecting falling highs. Stay short below the line.",
          },
          side: {
            title: "Sideways (Range-bound)",
            desc: "Price oscillates between support and resistance. Buy low, sell high within range.",
          },
        },
        tips: {
          title: "💡 Pro Tips",
      ...
      3: {
        ...
        macd: {
          ...
          signal:
            '<strong class="text-white">Signal:</strong> Cross above signal line = Buy, below = Sell',
        },
        notes: {
      ...
      4: {
        ...
        rev: {
          ...
          hs: {
            ...
            desc: "Three peaks: middle is highest. Indicates trend reversal to bearish.",
            trade: "Sell when neckline breaks",
          },
          double: {
            title: "Double Top / Bottom",
            desc: "Two peaks/troughs at same level. Failed attempt to break level.",
            trade: "Confirm with volume",
          },
        },
        cont: {
          ...
          tri: {
            title: "Triangles",
            desc: "Ascending (bullish), Descending (bearish), Symmetrical (wait for breakout)",
          },
          flag: {
            title: "Flags & Pennants",
            desc: "Short consolidation after strong move. Usually continues trend.",
          },
        },
        candles: {
          title: "🕯️ Candlestick Patterns",
          list: [
            '<strong class="text-white">Doji:</strong> Indecision',
            '<strong class="text-white">Hammer:</strong> Bullish reversal',
            '<strong class="text-white">Shooting Star:</strong> Bearish reversal',
            '<strong class="text-white">Engulfing:</strong> Large candle engulfs previous',
            '<strong class="text-white">Morning Star:</strong> Bullish reversal',
            '<strong class="text-white">Evening Star:</strong> Bearish reversal',
          ],
        },
      },
      5: {
        ...
        spikes: {
          ...
          list: [
            "Institutional money entering/exiting",
            "News/Event",
            "Potential reversal",
        ...
        crypto: {
          ...
          list: [
            "24/7 markets = volume spread out",
            "Wash trading is common - verify sources",
            "Low volume coins easy to manipulate",
          ],
        },
      },
      6: {
        ...
        trend: {
          ...
          list: [
            ...
            "Exit: Trend line break",
          ],
        },
        range: {
          title: "🔄 Range Trading",
          desc: "Buy support, sell resistance",
          list: [
            "Entry: Near support, RSI < 40",
            "Target: Resistance",
            "Stop: Below support",
            "Best: Sideways markets",
          ],
        },
        breakout: {
          title: "💥 Breakout Trading",
          desc: "Trade strong breakouts",
          list: [
            "Setup: Consolidation near resistance",
            "Entry: Break + Volume",
            "Confirm: Retest holds",
    ...
    sections: {
      1: {
        ...
        types: {
          ...
          line: {
            title: "Gráficos de Línea",
            desc: "Precio simple en el tiempo. Bueno para principiantes.",
            best: "✓ Mejor para: Identificar tendencias",
          },
          candle: {
            title: "Gráficos de Velas",
            desc: "Muestra OHLC (Apertura, Alto, Bajo, Cierre)",
            best: "✓ Mejor para: Reconocimiento de patrones",
          },
          heikin: {
            title: "Heikin-Ashi",
            desc: "Velas suavizadas, menos ruido",
            best: "✓ Mejor para: Confirmar tendencias",
          },
        },
        candles: {
          title: "Entendiendo las Velas",
          bull: {
            title: "Vela Alcista (Verde)",
            list: [
              "Cierre > Apertura",
          ...
          bear: {
            title: "Vela Bajista (Roja)",
            list: ["Cierre < Apertura", "Vendedores en control", "Precio bajó"],
          },
        },
        timeframes: {
      ...
      2: {
        ...
        sr: {
          sup: {
            title: "📈 Soporte",
            desc: "Nivel donde el interés de compra previene caídas",
            list: [
              'Actúa como "piso"',
              "Entran compradores",
              "Si se rompe, se vuelve resistencia",
              "Ej: BTC rebotando en $30k",
            ],
          },
          res: {
            title: "📉 Resistencia",
            desc: "Nivel donde la presión de venta previene subidas",
            list: [
              'Actúa como "techo"',
              "Entran vendedores",
              "Si se rompe, se vuelve soporte",
              "Ej: ETH rechazado en $2k",
            ],
          },
        },
        trends: {
          ...
          up: {
            title: "Alcista (Altos más altos, Bajos más altos)",
            desc: "Dibuja línea uniendo bajos ascendentes. Mantén largos sobre la línea.",
          },
          down: {
            title: "Bajista (Altos más bajos, Bajos más bajos)",
            desc: "Dibuja línea uniendo altos descendentes. Mantén cortos bajo la línea.",
          },
          side: {
            title: "Lateral (Rango)",
            desc: "El precio oscila entre soporte y resistencia. Compra bajo, vende alto en el rango.",
          },
        },
        tips: {
          title: "💡 Tips Pro",
      ...
      3: {
        ...
        macd: {
          ...
          signal:
            '<strong class="text-white">Señal:</strong> Cruce sobre línea señal = Compra, bajo = Venta',
        },
        notes: {
      ...
      4: {
        ...
        rev: {
          ...
          hs: {
            ...
            desc: "Tres picos: medio más alto. Indica cambio a bajista.",
            trade: "Vender al romper línea de cuello",
          },
          double: {
            title: "Doble Techo / Suelo",
            desc: "Dos picos/valles al mismo nivel. Intento fallido de romper.",
            trade: "Confirmar con volumen",
          },
        },
        cont: {
          ...
          tri: {
            title: "Triángulos",
            desc: "Ascendente (alcista), Descendente (bajista), Simétrico (esperar ruptura)",
          },
          flag: {
            title: "Banderas y Banderines",
            desc: "Consolidación corta tras movimiento fuerte. Usualmente sigue tendencia.",
          },
        },
        candles: {
          title: "🕯️ Patrones de Velas",
          list: [
            '<strong class="text-white">Doji:</strong> Indecisión',
            '<strong class="text-white">Martillo:</strong> Reversión alcista',
            '<strong class="text-white">Estrella Fugaz:</strong> Reversión bajista',
            '<strong class="text-white">Envolvente:</strong> Vela grande cubre anterior',
            '<strong class="text-white">Estrella Mañana:</strong> Reversión alcista',
            '<strong class="text-white">Estrella Tarde:</strong> Reversión bajista',
          ],
        },
      },
      5: {
        ...
        principles: {
          ...
          up_down:
            "Tendencia Alcista + Volumen Bajando: Tendencia debilitándose",
        ...
        crypto: {
          title: "💡 Notas Cripto",
          list: [
            "Mercados 24/7 = volumen disperso",
            "Wash trading común - verificar fuentes",
            "Monedas de bajo volumen fáciiles de manipular",
          ],
        },
      },
      6: {
        ...
        trend: {
          title: "📈 Seguimiento de Tenencia",
          desc: "Monta la tendencia",
          list: [
            "Entrada: Retroceso a MA",
            "Confirmar: RSI > 50",
            "Stop: Bajo swing low",
            "Salida: Ruptura línea tendencia",
          ],
        },
        range: {
          title: "🔄 Trading de Rango",
          desc: "Compra soporte, vende resistencia",
          list: [
            "Entrada: Cerca soporte, RSI < 40",
            "Objetivo: Resistencia",
            "Stop: Bajo soporte",
            "Mejor: Mercados laterales",
          ],
        },
        breakout: {
          title: "💥 Trading de Ruptura",
          desc: "Opera quiebres fuertes",
          list: [
            "Setup: Consolidación en resistencia",
            "Entrada: Ruptura + Volumen",
            "Confirmar: Retest aguanta",
        ...
        scalp: {
          ...
          list: [
            "Tiempo: 1m-5m",
            "Objetivo: 0.5-1% ganancia",
            "Volumen: Alta liquidez necesaria",
            "Nota: Alto estrés",
          ],
        },
        risk: {
                      ...
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-5">
                          <h4 className="text-green-400 font-semibold mb-3">
                            {t.sections[1].types.title}
                          </h4>
                          <div className="grid md:grid-cols-3 gap-3">
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-2">
                                {t.sections[1].types.line.title}
                              </h5>
                              <p className="text-xs text-slate-400 mb-2">
                                {t.sections[1].types.line.desc}
                              </p>
                              <p className="text-xs text-green-400">
                                {t.sections[1].types.line.best}
                              </p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-2">
                                {t.sections[1].types.candle.title}
                              </h5>
                              <p className="text-xs text-slate-400 mb-2">
                                {t.sections[1].types.candle.desc}
                              </p>
                              <p className="text-xs text-green-400">
                                {t.sections[1].types.candle.best}
                              </p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-2">
                                {t.sections[1].types.heikin.title}
                              </h5>
                              <p className="text-xs text-slate-400 mb-2">
                                {t.sections[1].types.heikin.desc}
                              </p>
                              <p className="text-xs text-green-400">
                                {t.sections[1].types.heikin.best}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                          <h5 className="text-blue-400 font-semibold mb-2">
                            {t.sections[1].candles.title}
                          </h5>
                          <div className="grid md:grid-cols-2 gap-3 text-sm">
                            <div>
                              <p className="text-white font-semibold mb-2">
                                {t.sections[1].candles.bull.title}
                              </p>
                              <ul className="text-xs text-slate-400 space-y-1">
                                {t.sections[1].candles.bull.list.map(
                                  (item, i) => (
                                    <li key={i}>• {item}</li>
                                  )
                                )}
                            ...
                            <div>
                              <p className="text-white font-semibold mb-2">
                                {t.sections[1].candles.bear.title}
                              </p>
                              <ul className="text-xs text-slate-400 space-y-1">
                                {t.sections[1].candles.bear.list.map(
                                  (item, i) => (
                                    <li key={i}>• {item}</li>
                                  )
                                )}
                        ...
                        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                          <h5 className="text-cyan-400 font-semibold mb-2">
                            {t.sections[1].timeframes.title}
                          </h5>
                          <p className="text-sm mb-2">
                            {t.sections[1].timeframes.desc}
                          </p>
                          <ul className="text-sm space-y-1">
                            {t.sections[1].timeframes.list.map((item, i) => (
                              <li key={i}>
                                •{" "}
                                <span
                      ...
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[2].sr.sup.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[2].sr.sup.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[2].sr.sup.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                          <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                            <h5 className="text-red-400 font-semibold mb-2">
                              {t.sections[2].sr.res.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[2].sr.res.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[2].sr.res.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5">
                          <h4 className="text-blue-400 font-semibold mb-3">
                            {t.sections[2].trends.title}
                          </h4>
                          <div className="space-y-3 text-sm">
                            <div>
                              <p className="text-white font-semibold">
                                {t.sections[2].trends.up.title}
                              </p>
                              <p className="text-xs text-slate-400">
                                {t.sections[2].trends.up.desc}
                              </p>
                            </div>
                            <div>
                              <p className="text-white font-semibold">
                                {t.sections[2].trends.down.title}
                              </p>
                              <p className="text-xs text-slate-400">
                                {t.sections[2].trends.down.desc}
                              </p>
                            </div>
                            <div>
                              <p className="text-white font-semibold">
                                {t.sections[2].trends.side.title}
                              </p>
                              <p className="text-xs text-slate-400">
                                {t.sections[2].trends.side.desc}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                          <h5 className="text-yellow-400 font-semibold mb-2 flex items-center gap-2">
                            {t.sections[2].tips.title}
                          </h5>
                          <ul className="text-sm space-y-1">
                            {t.sections[2].tips.list.map((item, i) => (
                              <li key={i}>• {item}</li>
                            ))}
                          </ul>
                        </div>
                  ...
                  {expandedSections.includes(2) && (
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[3].ma.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[3].ma.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[3].ma.list.map((item, i) => (
                                <li
                                  key={i}
                          ...
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[3].rsi.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[3].rsi.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[3].rsi.list.map((item, i) => (
                                <li
                                  key={i}
                                  dangerouslySetInnerHTML={{
                                    __html: `• ${item}`,
                        ...
                        <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-5">
                          <h4 className="text-green-400 font-semibold mb-3">
                            {t.sections[3].macd.title}
                          </h4>
                          <p className="text-sm mb-3">
                            {t.sections[3].macd.desc}
                          </p>
                          <div className="grid md:grid-cols-3 gap-3 text-xs">
                            <div className="bg-slate-800/50 rounded p-2 text-slate-400">
                              {t.sections[3].macd.line}
                            </div>
                            <div className="bg-slate-800/50 rounded p-2 text-slate-400">
                              {t.sections[3].macd.sig}
                            </div>
                            <div className="bg-slate-800/50 rounded p-2 text-slate-400">
                              {t.sections[3].macd.hist}
                            </div>
                          </div>
                          <p
                            className="text-sm mt-3"
                            dangerouslySetInnerHTML={{
                              __html: t.sections[3].macd.signal,
                            }}
                          />
                        </div>
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                          <h5 className="text-yellow-400 font-semibold mb-2">
                            {t.sections[3].notes.title}
                          </h5>
                          <ul className="text-sm space-y-1">
                            {t.sections[3].notes.list.map((item, i) => (
                              <li key={i}>• {item}</li>
                            ))}
                          </ul>
                        </div>
                      ...
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-5">
                          <h4 className="text-red-400 font-semibold mb-3">
                            {t.sections[4].rev.title}
                          </h4>
                          <div className="space-y-3">
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-1">
                                {t.sections[4].rev.hs.title}
                              </h5>
                              <p className="text-xs text-slate-400 mb-2">
                                {t.sections[4].rev.hs.desc}
                              </p>
                              <p className="text-xs text-green-400">
                                {t.sections[4].rev.hs.trade}
                              </p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-1">
                                {t.sections[4].rev.double.title}
                              </h5>
                              <p className="text-xs text-slate-400 mb-2">
                                {t.sections[4].rev.double.desc}
                              </p>
                              <p className="text-xs text-green-400">
                                {t.sections[4].rev.double.trade}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5">
                          <h4 className="text-blue-400 font-semibold mb-3">
                            {t.sections[4].cont.title}
                          </h4>
                          <div className="grid md:grid-cols-2 gap-3">
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-1">
                                {t.sections[4].cont.tri.title}
                              </h5>
                              <p className="text-xs text-slate-400">
                                {t.sections[4].cont.tri.desc}
                              </p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <h5 className="text-white font-semibold text-sm mb-1">
                                {t.sections[4].cont.flag.title}
                              </h5>
                              <p className="text-xs text-slate-400">
                                {t.sections[4].cont.flag.desc}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                          <h5 className="text-purple-400 font-semibold mb-2">
                            {t.sections[4].candles.title}
                          </h5>
                          <div className="grid md:grid-cols-3 gap-2 text-xs">
                            {t.sections[4].candles.list.map((item, i) => (
                              <div
                                key={i}
                                dangerouslySetInnerHTML={{ __html: item }}
                              />
                    ...
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex gap-2">
                              ...
                              <div>
                                <strong className="text-white">
                                  {t.sections[5].principles.up_up.split(":")[0]}
                                  :
                                </strong>
                                {t.sections[5].principles.up_up.split(":")[1]}
                              </div>
                            </div>
                            <div className="flex gap-2">
                              ...
                              <div>
                                <strong className="text-white">
                                  {
                                    t.sections[5].principles.up_down.split(
                                      ":"
                                    )[0]
                                  }
                                  :
                                </strong>
                                {t.sections[5].principles.up_down.split(":")[1]}
                              </div>
                            </div>
                            <div className="flex gap-2">
                              <span className="text-green-400">✓</span>
                              <div>
                                <strong className="text-white">
                                  {
                                    t.sections[5].principles.break_high.split(
                                      ":"
                                    )[0]
                                  }
                                  :
                            ...
                            <div className="flex gap-2">
                              ...
                              <div>
                                <strong className="text-white">
                                  {
                                    t.sections[5].principles.break_low.split(
                                      ":"
                                    )[0]
                                  }
                                  :
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[5].spikes.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[5].spikes.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[5].spikes.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[5].obv.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[5].obv.desc}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                          <h5 className="text-cyan-400 font-semibold mb-2">
                            {t.sections[5].crypto.title}
                          </h5>
                          <ul className="text-sm space-y-1">
                            {t.sections[5].crypto.list.map((item, i) => (
                              <li key={i}>• {item}</li>
                            ))}
                          </ul>
                        </div>
                    ...
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[6].trend.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[6].trend.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].trend.list.map((item, i) => (
                                <li key={i}>
                                  •{" "}
                                  <span
                                    dangerouslySetInnerHTML={{ __html: item }}
                          ...
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[6].range.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[6].range.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].range.list.map((item, i) => (
                                <li key={i}>
                                  •{" "}
                                  <span
                                    dangerouslySetInnerHTML={{ __html: item }}
                          ...
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[6].breakout.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[6].breakout.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].breakout.list.map((item, i) => (
                                <li key={i}>
                                  •{" "}
                                  <span
                                    dangerouslySetInnerHTML={{ __html: item }}
                          ...
                          <div className="bg-pink-500/10 border border-pink-500/20 rounded-lg p-4">
                            <h5 className="text-pink-400 font-semibold mb-2">
                              {t.sections[6].scalp.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[6].scalp.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].scalp.list.map((item, i) => (
                                <li key={i}>
                                  •{" "}
                                  <span
                                    dangerouslySetInnerHTML={{ __html: item }}
                        ...
                        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5">
                          <h4 className="text-red-400 font-semibold mb-3 flex items-center gap-2">
                            {t.sections[6].risk.title}
                          </h4>
                          <ul className="text-sm space-y-2">
                            {t.sections[6].risk.list.map((item, i) => (
                              <li key={i}>• {item}</li>
                            ))}
                          </ul>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-green-500/10 to-cyan-500/10 border border-green-500/20 rounded-lg p-5 text-center">
                          <h5 className="text-white font-semibold mb-2">
                            {t.sections[6].final.title}
                          </h5>
                          <p className="text-sm text-slate-400">
                            {t.sections[6].final.desc}
                          </p>
                        </div>
