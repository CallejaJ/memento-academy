...
const translations = {
  en: {
    ...
    description: "Master blockchain architecture and build decentralized applications. Learn consensus mechanisms, scalability solutions, and real-world dApp development.",
    modules: "Modules",
    level: "Level",
    duration: "Duration",
    level_val: "Advanced",
    ...
    sections: {
      1: {
        ...
        components: {
          ...
          blocks: { title: "Blocks", desc: "Container of transactions with timestamp, hash, and previous hash" },
          chain: { title: "Chain", desc: "Linked blocks creating immutable history via cryptographic hashes" },
          nodes: { title: "Nodes", desc: "Computers that validate, store, and distribute blockchain data" },
          consensus: { title: "Consensus", desc: "Agreement mechanism for adding new blocks (PoW, PoS, etc.)" }
        },
        crypto: {
      ...
      2: {
        ...
        pow: { title: "⛏️ Proof of Work (PoW)", sub: "Miners solve computational puzzles", list: ["Used by: Bitcoin, Ethereum (pre-Merge)", "Pros: Highly secure, battle-tested", "Cons: Energy intensive, slow"] },
        pos: { title: "🎯 Proof of Stake (PoS)", sub: "Validators stake tokens to secure network", list: ["Used by: Ethereum, Solana, Cardano", "Pros: Energy efficient, faster", "Cons: Plutocracy risk, less tested"] },
        other: { title: "⚡ Other Mechanisms", list: ["DPoS: Delegated Proof of Stake (EOS, Tron)", "PoA: Proof of Authority (private chains)", "PoH: Proof of History (Solana's innovation)"] }
      },
      3: {
        ...
        bloat: "💡 <strong class=\"text-white\">State Bloat:</strong> As state grows, node requirements increase. Archive nodes store all historical states while full nodes only keep recent state."
      },
      4: {
        ...
        approaches: {
          ...
          l2: { title: "Layer 2 Solutions", desc: "Process transactions off-chain, settle on mainnet. Examples: Optimism, Arbitrum, Polygon zkEVM" },
          sharding: { title: "Sharding", desc: "Split blockchain into parallel chains (shards). Ethereum 2.0's long-term plan" },
          channels: { title: "State Channels", desc: "Off-chain direct peer interactions. Lightning Network (Bitcoin)" }
        }
      },
      5: {
        ...
        tools: {
          ...
          dev: { title: "Development", list: ["Hardhat / Foundry: Smart contract frameworks", "Remix: Browser IDE", "OpenZeppelin: Audited contract libraries"] },
          frontend: { title: "Frontend", list: ["ethers.js / viem: Blockchain interaction", "RainbowKit / ConnectKit: Wallet connection", "The Graph: Data indexing & querying"] }
        }
      },
      6: {
  ...
  es: {
    ...
    description: "Domina la arquitectura blockchain y construye aplicaciones descentralizadas. Aprende mecanismos de consenso, soluciones de escalabilidad y desarrollo de dApps en el mundo real.",
    modules: "Módulos",
    level: "Nivel",
    duration: "Duración",
    level_val: "Avanzado",
    ...
    sections: {
      1: {
        ...
        components: {
          ...
          blocks: { title: "Bloques", desc: "Contenedor de transacciones con marca de tiempo, hash y hash anterior" },
          chain: { title: "Cadena", desc: "Bloques enlazados creando historia inmutable vía hashes criptográficos" },
          nodes: { title: "Nodos", desc: "Computadoras que validan, almacenan y distribuyen datos de blockchain" },
          consensus: { title: "Consenso", desc: "Mecanismo de acuerdo para añadir nuevos bloques (PoW, PoS, etc.)" }
        },
        crypto: {
      ...
      2: {
        ...
        pow: { title: "⛏️ Proof of Work (PoW)", sub: "Mineros resuelven acertijos computacionales", list: ["Usado por: Bitcoin, Ethereum (pre-Merge)", "Pros: Altamente seguro, probado en batalla", "Contras: Intensivo en energía, lento"] },
        pos: { title: "🎯 Proof of Stake (PoS)", sub: "Validadores hacen staking de tokens para asegurar la red", list: ["Usado por: Ethereum, Solana, Cardano", "Pros: Eficiente energéticamente, más rápido", "Contras: Riesgo de plutocracia, menos probado"] },
        other: { title: "⚡ Otros Mecanismos", list: ["DPoS: Delegated Proof of Stake (EOS, Tron)", "PoA: Proof of Authority (cadenas privadas)", "PoH: Proof of History (innovación de Solana)"] }
      },
      3: {
        ...
        bloat: "💡 <strong class=\"text-white\">Hinchazón de Estado:</strong> Al crecer el estado, los requisitos de nodo aumentan. Los nodos archivo guardan todo, los nodos completos solo el estado reciente."
      },
      4: {
        ...
        approaches: {
          ...
          l2: { title: "Soluciones Capa 2", desc: "Procesan transacciones fuera de cadena, liquidan en mainnet. Ej: Optimism, Arbitrum" },
          sharding: { title: "Sharding", desc: "Dividir blockchain en cadenas paralelas. Plan a largo plazo de Ethereum 2.0" },
          channels: { title: "Canales de Estado", desc: "Interacciones directas fuera de cadena. Lightning Network (Bitcoin)" }
        }
      },
      5: {
        ...
        tools: {
          ...
          dev: { title: "Desarrollo", list: ["Hardhat / Foundry: Frameworks de contratos", "Remix: IDE en navegador", "OpenZeppelin: Librerías auditadas"] },
          frontend: { title: "Frontend", list: ["ethers.js / viem: Interacción blockchain", "RainbowKit: Conexión de wallet", "The Graph: Indexación de datos"] }
        }
      },
      6: {
                  ...
                  <div className="p-4 flex items-center justify-between cursor-pointer" onClick={() => toggleSection(0)}>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-400">{t.sections[1].subtitle}</p>
                      </div>
                    </div>
                    ...
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="bg-violet-500/10 border border-violet-500/20 rounded-xl p-5">
                          <h4 className="text-violet-400 font-semibold mb-3">{t.sections[1].components.title}</h4>
                          <div className="grid md:grid-cols-2 gap-3 text-sm">
                            <div className="bg-slate-800/50 rounded p-3">
                              <p className="text-white font-semibold mb-1">{t.sections[1].components.blocks.title}</p>
                              <p className="text-xs text-slate-400">{t.sections[1].components.blocks.desc}</p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <p className="text-white font-semibold mb-1">{t.sections[1].components.chain.title}</p>
                              <p className="text-xs text-slate-400">{t.sections[1].components.chain.desc}</p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <p className="text-white font-semibold mb-1">{t.sections[1].components.nodes.title}</p>
                              <p className="text-xs text-slate-400">{t.sections[1].components.nodes.desc}</p>
                            </div>
                            <div className="bg-slate-800/50 rounded p-3">
                              <p className="text-white font-semibold mb-1">{t.sections[1].components.consensus.title}</p>
                              <p className="text-xs text-slate-400">{t.sections[1].components.consensus.desc}</p>
                            </div>
                          </div>
                        </div>

                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                          <h5 className="text-blue-400 font-semibold mb-2">{t.sections[1].crypto.title}</h5>
                        ...
                        <div className="mt-6 flex justify-center">
                          <SectionCompleteButton courseId="blockchain-development" sectionId="section-1" sectionNumber={1} totalSections={6} lng={lng} />
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <Card className="bg-slate-900/50 border-slate-800 hover:border-slate-700 transition-all ml-4">
                    <div className="p-4 flex items-center justify-between cursor-pointer" onClick={() => toggleSection(section.idx)}>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-white">{section.idx + 1}. {section.title}</h3>
                    ...
                    {expandedSections.includes(section.idx) && (
                      <div className="px-6 pb-6">
                        <div className="space-y-4 text-slate-300">
                            ...
                            <>
                              <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                                  <h5 className="text-purple-400 font-semibold mb-2">{t.sections[2].pow.title}</h5>
                                  <p className="text-sm mb-2">{t.sections[2].pow.sub}</p>
                                  <ul className="text-xs text-slate-400 space-y-1">
                                    {t.sections[2].pow.list.map((item: string, i: number) => <li key={i}>• {item}</li>)}
                                  </ul>
                                </div>
                                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                                  <h5 className="text-blue-400 font-semibold mb-2">{t.sections[2].pos.title}</h5>
                                  <p className="text-sm mb-2">{t.sections[2].pos.sub}</p>
                                  <ul className="text-xs text-slate-400 space-y-1">
                                    {t.sections[2].pos.list.map((item: string, i: number) => <li key={i}>• {item}</li>)}
                                  </ul>
                                </div>
                              </div>
                              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                                <h5 className="text-cyan-400 font-semibold mb-2">{t.sections[2].other.title}</h5>
                                <ul className="text-sm">
                                  {t.sections[2].other.list.map((item: string, i: number) => (
                                    <li key={i}>• <span dangerouslySetInnerHTML={{ __html: item.replace(':', ':</strong>') }} /></li>
                                  ))}
                                </ul>
                              </div>
                            </>
                          ...
                          {section.idx === 2 && (
                            <>
                              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-xl p-5">
                                <h4 className="text-cyan-400 font-semibold mb-3">{t.sections[3].types.title}</h4>
                                <ul className="text-sm space-y-2">
                                  {t.sections[3].types.list.map((item: string, i: number) => (
                                    <li key={i}>• <span dangerouslySetInnerHTML={{ __html: item }} /></li>
                                  ))}
                                </ul>
                              </div>
                              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                                <p className="text-sm" dangerouslySetInnerHTML={{ __html: t.sections[3].bloat }} />
                              </div>
                            </>
                          )}
                          ...
                          {section.idx === 3 && (
                            <>
                              <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-5">
                                <h4 className="text-green-400 font-semibold mb-3">{t.sections[4].approaches.title}</h4>
                                <div className="space-y-3 text-sm">
                                  <div className="bg-slate-800/50 rounded p-3">
                                    <p className="text-white font-semibold mb-1">{t.sections[4].approaches.l2.title}</p>
                                    <p className="text-xs text-slate-400">{t.sections[4].approaches.l2.desc}</p>
                                  </div>
                                  <div className="bg-slate-800/50 rounded p-3">
                                    <p className="text-white font-semibold mb-1">{t.sections[4].approaches.sharding.title}</p>
                                    <p className="text-xs text-slate-400">{t.sections[4].approaches.sharding.desc}</p>
                                  </div>
                                  <div className="bg-slate-800/50 rounded p-3">
                                    <p className="text-white font-semibold mb-1">{t.sections[4].approaches.channels.title}</p>
                                    <p className="text-xs text-slate-400">{t.sections[4].approaches.channels.desc}</p>
                                  </div>
                                </div>
                              </div>
                            </>
                          ...
                          {section.idx === 4 && (
                            <>
                              <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-5">
                                <h4 className="text-orange-400 font-semibold mb-3">{t.sections[5].tools.title}</h4>
                                <div className="grid md:grid-cols-2 gap-3 text-sm">
                                  <div>
                                    <p className="text-white font-semibold mb-2">{t.sections[5].tools.dev.title}</p>
                                    <ul className="text-xs text-slate-400 space-y-1">
                                      {t.sections[5].tools.dev.list.map((item: string, i: number) => <li key={i}>• {item}</li>)}
                                    </ul>
                                  </div>
                                  <div>
                                    <p className="text-white font-semibold mb-2">{t.sections[5].tools.frontend.title}</p>
                                    <ul className="text-xs text-slate-400 space-y-1">
                                      {t.sections[5].tools.frontend.list.map((item: string, i: number) => <li key={i}>• {item}</li>)}
                                    </ul>
                                  </div>
                                </div>
                              </div>
                          ...
                          {section.idx === 5 && (
                            <>
                              <div className="bg-pink-500/10 border border-pink-500/20 rounded-xl p-5">
                                <h4 className="text-pink-400 font-semibold mb-3">{t.sections[6].arch.title}</h4>
                                <ol className="text-sm space-y-2">
                                  {t.sections[6].arch.steps.map((item: string, i: number) => (
                              ...
                              <div className="bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 border border-violet-500/20 rounded-lg p-5 text-center">
                                <h5 className="text-white font-semibold mb-2">{t.sections[6].start.title}</h5>
                          ...
                          <div className="mt-6 flex justify-center">
                            <SectionCompleteButton courseId="blockchain-development" sectionId={`section-${section.idx + 1}`} sectionNumber={section.idx + 1} totalSections={6} lng={lng} />
                          </div>
                        </div>
                      </div>
                    )}
      ...
      <Card className="bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 border-violet-500/20 mt-8 mb-16 max-w-4xl mx-auto">
        <CardContent className="p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={`/${lng}/courses`}>
              <Button variant="outline" className="border-slate-700 text-slate-300 hover:bg-slate-800">{t.back_to_courses}</Button>
            </Link>
            <Link href={`/${lng}/dashboard`}>
              <Button className="bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600">{t.track_progress}</Button>
            </Link>
          </div>
        </CardContent>
      </Card>
