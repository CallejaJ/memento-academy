    ...
    sections: {
      1: {
        ...
        chips: {
          blue: {
            title: "💎 Blue Chips",
            desc: "BTC, ETH - Established, lower risk",
            alloc: "Allocation: 40-60%",
          },
          mid: {
            title: "🚀 Mid Caps",
            desc: "SOL, AVAX - Higher potential",
            alloc: "Allocation: 20-40%",
          },
          small: {
            title: "💥 Small Caps",
            desc: "New projects - High risk/reward",
            alloc: "Allocation: 5-20%",
          },
        },
        goals: {
    ...
    other_sections: [
      {
        ...
        content:
          "Diversification reduces risk by spreading investments across different assets, sectors, and strategies.",
        details: {
      ...
      },
      {
        ...
        content:
          "Risk management is about preserving capital during downturns while maintaining upside potential.",
        details: {
          type: "risk",
      ...
      },
      {
        ...
        content:
          "Rebalancing ensures your portfolio stays aligned with your strategy as market conditions change.",
        details: {
          type: "rebalance",
          ...
          methods: [
            {
              title: "Time-Based",
              desc: "Rebalance monthly/quarterly regardless of deviation",
            },
            {
              title: "Threshold-Based",
              desc: "Rebalance when allocation drifts > 5-10% from target",
            },
          ],
        },
      },
      {
        ...
        content:
          "Understanding crypto taxes helps you legally minimize tax burden and maximize net returns.",
        details: {
          type: "tax",
      ...
      },
      {
        ...
        content:
          "Track your portfolio's performance to make informed decisions and improve your strategy over time.",
        details: {
          type: "tracking",
          title: "📊 Key Metrics",
          list: [
    ...
    sections: {
      1: {
        ...
        chips: {
          blue: {
            title: "💎 Blue Chips",
            desc: "BTC, ETH - Establecidos, menor riesgo",
            alloc: "Asignación: 40-60%",
          },
          mid: {
            title: "🚀 Mid Caps",
            desc: "SOL, AVAX - Mayor potencial",
            alloc: "Asignación: 20-40%",
          },
          small: {
            title: "💥 Small Caps",
            desc: "Proyectos nuevos - Alto riesgo/retorno",
            alloc: "Asignación: 5-20%",
          },
        },
        goals: {
    ...
    other_sections: [
      {
        ...
        content:
          "La diversificación reduce el riesgo esparciendo inversiones en diferentes activos, sectores y estrategias.",
        details: {
          type: "diversification",
      ...
      },
      {
        ...
        content:
          "La gestión de riesgo trata de preservar capital durante caídas manteniendo potencial de subida.",
        details: {
          type: "risk",
      ...
      },
      {
        ...
        content:
          "El rebalanceo asegura que tu portafolio siga alineado con tu estrategia al cambiar el mercado.",
        details: {
          type: "rebalance",
          ...
          methods: [
            {
              ...
              desc: "Rebalancear mensual/trimestral sin importar la desviación",
            },
            {
              title: "Basado en Umbral",
              desc: "Rebalancear cuando la asignación se desvía > 5-10% del objetivo",
            },
          ],
        },
      },
      {
        ...
        content:
          "Entender los impuestos cripto te ayuda a minimizar legalmente la carga fiscal y maximizar retornos netos.",
        details: {
          type: "tax",
      ...
      },
      {
        ...
        content:
          "Rastrea el rendimiento de tu portafolio para tomar decisiones informadas y mejorar tu estrategia.",
        details: {
          type: "tracking",
                        ...
                        <div className="grid md:grid-cols-3 gap-3">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[1].chips.blue.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[1].chips.blue.desc}
                            </p>
                            <p className="text-xs text-green-400">
                              {t.sections[1].chips.blue.alloc}
                            </p>
                          </div>
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[1].chips.mid.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[1].chips.mid.desc}
                            </p>
                            <p className="text-xs text-green-400">
                              {t.sections[1].chips.mid.alloc}
                            </p>
                          </div>
                          <div className="bg-pink-500/10 border border-pink-500/20 rounded-lg p-4">
                            <h5 className="text-pink-400 font-semibold mb-2">
                              {t.sections[1].chips.small.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[1].chips.small.desc}
                            </p>
                            <p className="text-xs text-green-400">
                              {t.sections[1].chips.small.alloc}
                            </p>
                          </div>
                        </div>
                              ...
                              <>
                                <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-5">
                                  ...
                                  <ul className="text-sm space-y-1">
                                    {section.details.list?.map((item, i) => (
                                      <li
                                        key={i}
