    ...
    sections: {
          ...
          steps: [
            {
              ...
              desc: "Digital artwork, 3D model, music, video - any digital file",
            },
            {
              title: "Choose Blockchain",
              desc: "Ethereum (most popular), Polygon (cheap), Solana (fast), Tezos (eco-friendly)",
            },
            {
              title: "Select Platform",
              desc: "OpenSea (beginner-friendly), Rarible, Foundation (curated), Zora (creator-owned)",
            },
            {
              title: "Upload & Add Metadata",
              desc: "Description, properties, royalties (typically 2.5-10%)",
            },
            {
              title: "Pay Gas Fees & Mint",
              desc: "Transaction confirms on blockchain - your NFT is live!",
            },
          ],
        },
        concepts: {
          lazy: {
            title: "💰 Lazy Minting",
            desc: "Defer gas costs until the NFT is sold. OpenSea and Rarible support this. Great for testing the market.",
          },
          coll: {
            title: "🎯 Collection vs Single",
            desc: "Single NFT: one piece. Collection: series with shared contract. Collections build brand value.",
          },
          rare: {
            title: "📊 Rarity & Traits",
            desc: "For PFP projects: define traits (background, eyes, accessories). Tools like Rarity.tools rank scarcity.",
          },
        },
        warn: {
      ...
      3: {
        ...
        markets: {
          os: {
            title: "🌊 OpenSea",
            desc: "Largest NFT marketplace with 80M+ items",
            list: [
              "2.5% platform fee",
              "Supports Ethereum, Polygon, Solana",
              "Easy for beginners",
              "Offers for collections & bundles",
            ],
          },
          blur: {
            title: "💎 Blur",
            desc: "Pro trader platform with zero fees",
            list: [
              "0% platform fee during beta",
              "Advanced trading tools",
              "Portfolio analytics",
              "Airdrop rewards for activity",
            ],
          },
          found: {
            title: "🎨 Foundation",
            desc: "Curated platform for digital artists",
            list: [
          ...
          magic: {
            title: "⚡ Magic Eden",
            desc: "Solana's leading NFT marketplace",
            list: [
              "2% platform fee",
        ...
        tips: {
          ...
          research: {
            ...
            list: [
              ...
              "Verify creator/collection",
              "Review trading volume & floor price",
              "Check rarity tools (for collections)",
            ],
          },
          safe: {
            ...
            list: [
              ...
              "Be wary of too-good offers (phishing)",
        ...
        pricing: {
          ...
          floor:
            '<strong class="text-cyan-400">Floor Price:</strong> Lowest listed price in a collection. Good entry point but may lack rare traits.',
      ...
      4: {
        ...
        strats: {
          blue: {
            title: "🎯 Blue-Chip Strategy",
            desc: "Invest in established collections with proven track records",
            list: [
              "CryptoPunks, BAYC, Azuki",
              "Lower risk, stable floor prices",
              "Strong community & utility",
              "Higher entry cost",
            ],
          },
          early: {
            title: "🚀 Early Adoption",
            desc: "Get in early on promising new projects",
            list: [
          ...
          rare: {
            title: "💎 Rarity Play",
            desc: "Target undervalued rare items in collections",
            list: [
              "Study rarity rankings",
        ...
        portfolio: {
          ...
          blue: {
            title: "Blue-Chips (30-40%)",
            desc: "Stable value, low risk",
          },
        ...
        flags: {
          ...
          list: [
            ...
            "Lack of utility or roadmap",
            "Suspicious social media activity (bots, fake engagement)",
            "Derivative art with no unique value proposition",
          ],
        },
      },
      5: {
        ...
        copyright: {
          ...
          own: {
            ...
            list: [
              ...
              "Right to sell/transfer the NFT",
              "Bragging rights & provenance",
              "Access to holder-only benefits",
            ],
          },
          dont: {
            title: "What You DON'T Own (Usually)",
            list: [
              "Copyright to the artwork",
              "Right to reproduce commercially",
        ...
        rights: {
          cc0: {
            title: "📜 CC0 NFTs",
            desc: '<strong class="text-white">Creative Commons Zero:</strong> Creator waives all rights. Holders can use however they want - commercially, derivatives, etc. Examples: CrypToadz, Nouns.',
          },
          comm: {
            title: "🎯 Commercial Rights",
            desc: "Some projects grant holders commercial rights. BAYC holders can create products using their ape. Always read the license terms!",
          },
        },
        tax: {
      ...
      6: {
        ...
        trends: {
          game: {
            ...
            desc: "Play-to-earn economies where your in-game assets have real value",
            list: [
              "Interoperable items across games",
              "Virtual land ownership (Decentraland, Sandbox)",
              "Cross-platform identities & avatars",
              "NFT-gated gaming experiences",
            ],
          },
          music: {
            title: "🎵 Music & Entertainment",
            desc: "Artists monetizing directly, fans owning a piece of culture",
            list: [
              "Royalty-sharing music NFTs",
              "Exclusive concert access & backstage passes",
              "Fan club memberships as NFTs",
              "Collaborative songs with holders",
            ],
          },
          rwa: {
            title: "🏠 Real World Assets (RWAs)",
            desc: "Tokenizing physical assets for fractional ownership",
            list: [
              "Real estate fractional ownership",
              "Luxury goods authentication (watches, bags)",
              "Equipment leasing & rental NFTs",
              "Supply chain tracking",
            ],
          },
          id: {
            title: "🆔 Identity & Credentials",
            desc: "Verifiable credentials and decentralized identity",
            list: [
              "Education diplomas as NFTs",
        ...
        tech: {
          ...
          dynamic: {
            title: "Dynamic NFTs",
            desc: "NFTs that change based on external data (weather, time, real-world events). Example: A soccer player card that updates stats in real-time.",
          },
          ai: {
            title: "AI-Generated NFTs",
            desc: "AI art tools integrated into minting platforms. Prompt-to-NFT in seconds.",
          },
        },
      },
    },
    ...
    sections: {
      ...
      2: {
        ...
        process: {
          ...
          steps: [
            {
              title: "Crea tu Arte",
              desc: "Arte digital, modelo 3D, música, video - cualquier archivo digital",
            },
            {
              title: "Elige Blockchain",
              desc: "Ethereum (más popular), Polygon (barato), Solana (rápido), Tezos (eco-friendly)",
            },
            {
              title: "Selecciona Plataforma",
              desc: "OpenSea (fácil para principiantes), Rarible, Foundation (curado), Zora (propiedad del creador)",
            },
            {
              title: "Sube y Añade Metadatos",
              desc: "Descripción, propiedades, regalías (típicamente 2.5-10%)",
            },
            {
              title: "Paga Gas y Mintea",
              desc: "La transacción se confirma en blockchain - ¡tu NFT está vivo!",
            },
          ],
        },
        concepts: {
          lazy: {
            title: "💰 Lazy Minting",
            desc: "Diferir costos de gas hasta que se venda el NFT. OpenSea y Rarible lo soportan. Genial para probar el mercado.",
          },
          coll: {
            title: "🎯 Colección vs Único",
            desc: "NFT Único: una pieza. Colección: serie con contrato compartido (ej. 10k PFP). Las colecciones construyen marca.",
          },
          rare: {
            title: "📊 Rareza y Rasgos",
            desc: "Para proyectos PFP: define rasgos (fondo, ojos). Herramientas como Rarity.tools clasifican la escasez.",
          },
        },
        warn: {
      ...
      3: {
        ...
        markets: {
          os: {
            title: "🌊 OpenSea",
            desc: "El mayor marketplace con 80M+ de ítems",
            list: [
              "2.5% tarifa de plataforma",
              "Soporta Ethereum, Polygon, Solana",
              "Fácil para principiantes",
              "Ofertas para colecciones",
            ],
          },
          blur: {
            title: "💎 Blur",
            desc: "Plataforma para traders pro sin tarifas",
            list: [
              "0% tarifa durante beta",
          ...
          found: {
            title: "🎨 Foundation",
            desc: "Plataforma curada para artistas digitales",
            list: [
              "15% comisión en ventas primarias",
              "Solo invitación",
              "Curaduría de alta calidad",
              "Comunidad enfocada en artistas",
            ],
          },
          magic: {
            title: "⚡ Magic Eden",
            desc: "El marketplace líder de Solana",
            list: [
              "2% tarifa de plataforma",
              "Bajos costos en Solana",
        ...
        tips: {
          ...
          research: {
            ...
            list: [
              "Revisa dirección del contrato",
              "Verifica creador/colección",
              "Revisa volumen y precio suelo",
              "Revisa herramientas de rareza",
            ],
          },
          safe: {
            ...
            list: [
              ...
              "Usa hardware wallets para NFTs valiosos",
              "Cuidado con ofertas muy buenas (phishing)",
              "Verifica URLs antes de conectar wallet",
            ],
          },
        },
        pricing: {
          ...
          floor:
            '<strong class="text-cyan-400">Precio Suelo (Floor):</strong> Precio listado más bajo en una colección. Buen punto de entrada pero quizás sin rasgos raros.',
      ...
      4: {
        ...
        strats: {
          blue: {
            title: "🎯 Estrategia Blue-Chip",
            desc: "Invierte en colecciones establecidas con historial probado",
            list: [
              "CryptoPunks, BAYC, Azuki",
              "Menor riesgo, precios suelo estables",
              "Fuerte comunidad y utilidad",
              "Costo de entrada alto",
            ],
          },
          early: {
            title: "🚀 Adopción Temprana",
            desc: "Entra temprano en proyectos nuevos prometedores",
            list: [
              "Investiga equipo y roadmap",
              "Mayor riesgo, mayor retorno potencial",
              "Oportunidades de Whitelist",
              "Engagement de comunidad crucial",
            ],
          },
          rare: {
            title: "💎 Jugada de Rareza",
            desc: "Busca ítems raros infravalorados en colecciones",
            list: [
              "Estudia rankings de rareza",
              "Busca errores de precio",
              "Mantén para apreciación",
        ...
        portfolio: {
          ...
          blue: {
            title: "Blue-Chips (30-40%)",
            desc: "Valor estable, bajo riesgo",
          },
          mid: { title: "Mid-Caps (30-40%)", desc: "Potencial de crecimiento" },
          spec: {
            title: "Especulativo (20-30%)",
            desc: "Alto riesgo/recompensa",
          },
        },
        flags: {
          ...
          list: [
            ...
            "Promesas irreales o retornos garantizados",
            "Falta de utilidad o roadmap",
            "Actividad sospechosa en redes (bots)",
            "Arte derivado sin propuesta de valor única",
          ],
        },
      },
      5: {
        ...
        copyright: {
          ...
          own: {
            ...
            list: [
              "El token NFT en sí",
              "Derecho a vender/transferir el NFT",
              "Derecho a alardear y procedencia",
              "Acceso a beneficios de holders",
            ],
          },
          dont: {
            title: "Lo que NO Posees (Usualmente)",
            list: [
              "Copyright de la obra de arte",
              "Derecho a reproducir comercialmente",
              "Derecho a crear derivados",
        ...
        rights: {
          cc0: {
            title: "📜 NFTs CC0",
            desc: '<strong class="text-white">Creative Commons Zero:</strong> El creador renuncia a todos los derechos. Los holders pueden usarlo como quieran (comercialmente, derivados). Ej: CrypToadz, Nouns.',
          },
          comm: {
            title: "🎯 Derechos Comerciales",
            desc: "Algunos proyectos otorgan derechos comerciales. Holders de BAYC pueden crear productos con su simio. ¡Lee siempre la licencia!",
          },
        },
        tax: {
          ...
          disclaimer:
            "*Consulta a un profesional fiscal para tu situación. Las leyes varían por país.",
        },
        reg: {
      ...
      6: {
        ...
        trends: {
          game: {
            ...
            desc: "Economías Play-to-earn donde tus activos in-game tienen valor real",
            list: [
              "Ítems interoperables entre juegos",
              "Propiedad de tierra virtual (Decentraland)",
              "Identidades y avatares multiplataforma",
              "Experiencias exclusivas para holders",
            ],
          },
          music: {
            title: "🎵 Música y Entretenimiento",
            desc: "Artistas monetizando directamente, fans poseyendo cultura",
            list: [
              "NFTs de música con regalías compartidas",
              "Acceso exclusivo a conciertos y backstage",
              "Membresías de club de fans",
              "Canciones colaborativas",
            ],
          },
          rwa: {
            title: "🏠 Activos del Mundo Real (RWAs)",
            desc: "Tokenizando activos físicos para propiedad fraccionada",
            list: [
              "Propiedad fraccionada de bienes raíces",
          ...
          id: {
            ...
            desc: "Credenciales verificables e identidad descentralizada",
            list: [
              "Diplomas educativos como NFTs",
              "Certificaciones profesionales",
              "Historiales médicos",
              "Tokens Soulbound (intransferibles)",
            ],
          },
        },
        tech: {
          ...
          dynamic: {
            ...
            desc: "NFTs que cambian basados en datos externos (clima, tiempo). Ej: Una carta de jugador de fútbol que actualiza estadísticas en tiempo real.",
          },
          ai: {
            title: "NFTs Generados por IA",
            desc: "Herramientas de arte IA integradas en plataformas de minteo. De prompt a NFT en segundos.",
          },
        },
      },
    },
                      ...
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-5">
                          <h4 className="text-purple-400 font-semibold mb-3">
                            {t.sections[1].special.title}
                          </h4>
                          <ul className="space-y-2 text-sm">
                            {t.sections[1].special.list.map((item, i) => (
                              <li
                                key={i}
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mt-4">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[1].types.art.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[1].types.art.desc}
                            </p>
                          </div>
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[1].types.game.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[1].types.game.desc}
                            </p>
                          </div>
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[1].types.music.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[1].types.music.desc}
                            </p>
                          </div>
                          <div className="bg-pink-500/10 border border-pink-500/20 rounded-lg p-4">
                            <h5 className="text-pink-400 font-semibold mb-2">
                              {t.sections[1].types.real.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[1].types.real.desc}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4 mt-4">
                          <h5 className="text-white font-semibold mb-2">
                            {t.sections[1].tech.title}
                          </h5>
                          <p className="text-sm mb-3">
                            {t.sections[1].tech.desc}
                          </p>
                      ...
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="bg-pink-500/10 border border-pink-500/20 rounded-xl p-5">
                          <h4 className="text-pink-400 font-semibold mb-3">
                            {t.sections[2].process.title}
                          </h4>
                          <ol className="space-y-3">
                            {t.sections[2].process.steps.map((step, i) => (
                              <li key={i} className="flex gap-2">
                                <span className="bg-pink-500/20 text-pink-400 rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 text-sm">
                                  {i + 1}
                                </span>
                                <div>
                        ...
                        <div className="grid md:grid-cols-3 gap-3 mt-4">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
                            <h5 className="text-blue-400 font-semibold text-sm mb-2">
                              {t.sections[2].concepts.lazy.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[2].concepts.lazy.desc}
                            </p>
                          </div>
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                            <h5 className="text-green-400 font-semibold text-sm mb-2">
                              {t.sections[2].concepts.coll.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[2].concepts.coll.desc}
                            </p>
                          </div>
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3">
                            <h5 className="text-purple-400 font-semibold text-sm mb-2">
                              {t.sections[2].concepts.rare.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[2].concepts.rare.desc}
                            </p>
                          </div>
                        </div>
                  ...
                  {expandedSections.includes(2) && (
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                        <p
                          className="text-lg"
                          dangerouslySetInnerHTML={{ __html: t.sections[3].p1 }}
                        />

                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[3].markets.os.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[3].markets.os.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[3].markets.os.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[3].markets.blur.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[3].markets.blur.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[3].markets.blur.list.map(
                                (item, i) => (
                                  <li key={i}>• {item}</li>
                                )
                              )}
                          ...
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[3].markets.found.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[3].markets.found.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[3].markets.found.list.map(
                                (item, i) => (
                                  <li key={i}>• {item}</li>
                                )
                              )}
                          ...
                          <div className="bg-pink-500/10 border border-pink-500/20 rounded-lg p-4">
                            <h5 className="text-pink-400 font-semibold mb-2">
                              {t.sections[3].markets.magic.title}
                            </h5>
                            <p className="text-sm mb-2">
                              {t.sections[3].markets.magic.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[3].markets.magic.list.map(
                                (item, i) => (
                                  <li key={i}>• {item}</li>
                                )
                              )}
                        ...
                        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-xl p-5 mt-4">
                          <h4 className="text-cyan-400 font-semibold mb-3">
                            {t.sections[3].tips.title}
                          </h4>
                          <div className="grid md:grid-cols-2 gap-3">
                            <div>
                              <p className="text-white font-semibold text-sm mb-1">
                                {t.sections[3].tips.research.title}
                              </p>
                              <ul className="text-xs text-slate-400 space-y-0.5">
                                {t.sections[3].tips.research.list.map(
                                  (item, i) => (
                                    <li key={i}>• {item}</li>
                                  )
                                )}
                            ...
                            <div>
                              <p className="text-white font-semibold text-sm mb-1">
                                {t.sections[3].tips.safe.title}
                              </p>
                              <ul className="text-xs text-slate-400 space-y-0.5">
                                {t.sections[3].tips.safe.list.map((item, i) => (
                                  <li key={i}>• {item}</li>
                                ))}
                              </ul>
                            </div>
                        ...
                        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                          <h5 className="text-white font-semibold mb-2">
                            {t.sections[3].pricing.title}
                          </h5>
                          <div className="space-y-2 text-sm">
                            <div
                              dangerouslySetInnerHTML={{
                                __html: t.sections[3].pricing.floor,
                              }}
                            />
                            <div
                              dangerouslySetInnerHTML={{
                                __html: t.sections[3].pricing.avg,
                              }}
                            />
                            <div
                              dangerouslySetInnerHTML={{
                                __html: t.sections[3].pricing.ceil,
                              }}
                            />
                          </div>
                        </div>
                    ...
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="grid md:grid-cols-3 gap-3">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[4].strats.blue.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[4].strats.blue.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[4].strats.blue.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[4].strats.early.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[4].strats.early.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[4].strats.early.list.map(
                                (item, i) => (
                                  <li key={i}>• {item}</li>
                                )
                              )}
                          ...
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[4].strats.rare.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[4].strats.rare.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[4].strats.rare.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                        ...
                        <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-5">
                          <h4 className="text-green-400 font-semibold mb-3">
                            {t.sections[4].portfolio.title}
                          </h4>
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between items-center">
                              <span className="text-white">
                                {t.sections[4].portfolio.blue.title}
                              </span>
                              <span className="text-slate-400">
                                {t.sections[4].portfolio.blue.desc}
                              </span>
                            </div>
                            ...
                            <div className="flex justify-between items-center mt-3">
                              <span className="text-white">
                                {t.sections[4].portfolio.mid.title}
                              </span>
                              <span className="text-slate-400">
                                {t.sections[4].portfolio.mid.desc}
                              </span>
                            </div>
                            <div className="w-full bg-slate-800 rounded-full h-2">
                              <div
                            ...
                            <div className="flex justify-between items-center mt-3">
                              <span className="text-white">
                                {t.sections[4].portfolio.spec.title}
                              </span>
                              <span className="text-slate-400">
                                {t.sections[4].portfolio.spec.desc}
                              </span>
                            </div>
                            <div className="w-full bg-slate-800 rounded-full h-2">
                              <div
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                          <h5 className="text-yellow-400 font-semibold mb-2 flex items-center gap-2">
                            {t.sections[4].flags.title}
                          </h5>
                          <ul className="text-sm space-y-1">
                            {t.sections[4].flags.list.map((item, i) => (
                              <li key={i}>• {item}</li>
                            ))}
                          </ul>
                        </div>
                      ...
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5">
                          <h4 className="text-red-400 font-semibold mb-3 flex items-center gap-2">
                            {t.sections[5].copyright.title}
                          </h4>
                          <div className="grid md:grid-cols-2 gap-4 text-sm">
                            <div>
                              <p className="text-white font-semibold mb-2">
                                {t.sections[5].copyright.own.title}
                              </p>
                              <ul className="text-xs text-slate-400 space-y-1">
                                {t.sections[5].copyright.own.list.map(
                                  (item, i) => (
                                    <li key={i}>✅ {item}</li>
                                  )
                                )}
                            ...
                            <div>
                              <p className="text-white font-semibold mb-2">
                                {t.sections[5].copyright.dont.title}
                              </p>
                              <ul className="text-xs text-slate-400 space-y-1">
                                {t.sections[5].copyright.dont.list.map(
                                  (item, i) => (
                                    <li key={i}>❌ {item}</li>
                                  )
                                )}
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[5].rights.cc0.title}
                            </h5>
                            <p
                              className="text-xs text-slate-400"
                              dangerouslySetInnerHTML={{
                                __html: t.sections[5].rights.cc0.desc,
                              }}
                            />
                          </div>
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[5].rights.comm.title}
                            </h5>
                            <p className="text-xs text-slate-400">
                              {t.sections[5].rights.comm.desc}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                          <h5 className="text-yellow-400 font-semibold mb-2">
                            {t.sections[5].tax.title}
                          </h5>
                          <p className="text-sm mb-2">
                            {t.sections[5].tax.desc}
                          </p>
                          <ul className="text-sm space-y-1">
                            {t.sections[5].tax.list.map((item, i) => (
                              <li key={i}>
                                •{" "}
                                <span
                                  dangerouslySetInnerHTML={{ __html: item }}
                          ...
                          <p className="text-xs text-slate-500 mt-2 italic">
                            {t.sections[5].tax.disclaimer}
                          </p>
                        </div>

                        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                          <h5 className="text-white font-semibold mb-2">
                            {t.sections[5].reg.title}
                          </h5>
                          <p className="text-sm mb-3">
                            {t.sections[5].reg.desc}
                          </p>
                          <div className="space-y-2 text-sm">
                            <div
                              dangerouslySetInnerHTML={{
                                __html: t.sections[5].reg.sec,
                              }}
                            />
                            <div
                              dangerouslySetInnerHTML={{
                                __html: t.sections[5].reg.aml,
                              }}
                            />
                            <div
                              dangerouslySetInnerHTML={{
                                __html: t.sections[5].reg.cons,
                              }}
                            />
                          </div>
                        </div>
                    ...
                    <div className="px-6 pb-6">
                      <div className="space-y-4 text-slate-300">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                            <h5 className="text-blue-400 font-semibold mb-2">
                              {t.sections[6].trends.game.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[6].trends.game.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].trends.game.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="text-green-400 font-semibold mb-2">
                              {t.sections[6].trends.music.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[6].trends.music.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].trends.music.list.map(
                                (item, i) => (
                                  <li key={i}>• {item}</li>
                                )
                              )}
                          ...
                          <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            <h5 className="text-purple-400 font-semibold mb-2">
                              {t.sections[6].trends.rwa.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[6].trends.rwa.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].trends.rwa.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                          <div className="bg-pink-500/10 border border-pink-500/20 rounded-lg p-4">
                            <h5 className="text-pink-400 font-semibold mb-2">
                              {t.sections[6].trends.id.title}
                            </h5>
                            <p className="text-xs text-slate-400 mb-2">
                              {t.sections[6].trends.id.desc}
                            </p>
                            <ul className="text-xs text-slate-400 space-y-1">
                              {t.sections[6].trends.id.list.map((item, i) => (
                                <li key={i}>• {item}</li>
                              ))}
                            </ul>
                          </div>
                        ...
                        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-xl p-5">
                          <h4 className="text-cyan-400 font-semibold mb-3">
                            {t.sections[6].tech.title}
                          </h4>
                          <div className="space-y-3">
                            <div>
                              <p className="text-white font-semibold text-sm">
                                {t.sections[6].tech.dynamic.title}
                              </p>
                              <p className="text-xs text-slate-400">
                                {t.sections[6].tech.dynamic.desc}
                              </p>
                            </div>
                            <div>
                              <p className="text-white font-semibold text-sm">
                                {t.sections[6].tech.ai.title}
                              </p>
                              <p className="text-xs text-slate-400">
                                {t.sections[6].tech.ai.desc}
                              </p>
                            </div>
                          </div>
                        </div>
