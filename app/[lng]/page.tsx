          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 bg-slate-900/50 border border-slate-800 p-8 rounded-3xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left max-w-5xl mx-auto mt-12">
                <div className="space-y-3 p-6 rounded-2xl bg-slate-800/30 border border-slate-800 hover:border-cyan-500/30 transition-colors">
                  ...
                  <h3 className="font-semibold text-white">{t('access.cards.library.title')}</h3>
                  <p className="text-sm text-slate-400">{t('access.cards.library.desc')}</p>
                </div>
                <div className="space-y-3 p-6 rounded-2xl bg-slate-800/30 border border-slate-800 hover:border-cyan-500/30 transition-colors">
                  <CheckCircle className="w-6 h-6 text-teal-400" />
                  <h3 className="font-semibold text-white">{t('access.cards.newsletter.title')}</h3>
                  <p className="text-sm text-slate-400">{t('access.cards.newsletter.desc')}</p>
                </div>
                <div className="space-y-3 p-6 rounded-2xl bg-slate-800/30 border border-slate-800 hover:border-cyan-500/30 transition-colors">
                  <CheckCircle className="w-6 h-6 text-teal-400" />
                  <h3 className="font-semibold text-white">{t('access.cards.cbdc.title')}</h3>
                  <p className="text-sm text-slate-400">{t('access.cards.cbdc.desc')}</p>
                </div>
                <div className="space-y-3 p-6 rounded-2xl bg-slate-800/30 border border-slate-800 hover:border-cyan-500/30 transition-colors">
                  <CheckCircle className="w-6 h-6 text-teal-400" />
                  <h3 className="font-semibold text-white">{t('access.cards.support.title')}</h3>
                  <p className="text-sm text-slate-400">{t('access.cards.support.desc')}</p>
                </div>
                <div className="space-y-3 p-6 rounded-2xl bg-slate-800/30 border border-slate-800 hover:border-cyan-500/30 transition-colors">
                  <CheckCircle className="w-6 h-6 text-teal-400" />
                  <h3 className="font-semibold text-white">{t('access.cards.security.title')}</h3>
                  <p className="text-sm text-slate-400">{t('access.cards.security.desc')}</p>
                </div>
                <div className="space-y-3 p-6 rounded-2xl bg-slate-800/30 border border-slate-800 hover:border-cyan-500/30 transition-colors">
                  <CheckCircle className="w-6 h-6 text-teal-400" />
                  <h3 className="font-semibold text-white">{t('access.cards.open.title')}</h3>
                  <p className="text-sm text-slate-400">{t('access.cards.open.desc')}</p>
                </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4 text-center shadow-lg">
                    ...
                    <div className="text-sm text-slate-400">{t('newsletter_section.stats.learners')}</div>
                  </div>
                  <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4 text-center shadow-lg">
                    <div className="text-2xl font-bold text-teal-400">Weekly</div>
                    <div className="text-sm text-slate-400">{t('newsletter_section.stats.weekly')}</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 font-medium">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-400" />
                    <span className="text-slate-300">{t('newsletter_section.list.1')}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-400" />
                    <span className="text-slate-300">{t('newsletter_section.list.2')}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-400" />
                    <span className="text-slate-300">{t('newsletter_section.list.3')}</span>
                  </div>
                </div>
              </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-4">{t('footer.cols.learn')}</h3>
              <ul className="space-y-3">
                <li><a href={`/${lng}/learn/web3-basics`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.web3')}</a></li>
                <li><a href={`/${lng}/learn/crypto-101`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.crypto')}</a></li>
                <li><a href={`/${lng}/learn/cbdc`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.cbdc')}</a></li>
                <li><a href={`/${lng}/learn/safety`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.safety')}</a></li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-lg mb-4">{t('footer.cols.academy')}</h3>
              <ul className="space-y-3">
                <li><a href={`/${lng}/about`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.mission')}</a></li>
                <li><a href={`/${lng}/courses`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.courses')}</a></li>
                <li><a href={`/${lng}/knowledge-base`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.kb')}</a></li>
                <li><a href={`/${lng}/contribute`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.contribute')}</a></li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-lg mb-4">{t('footer.cols.connect')}</h3>
              <ul className="space-y-3">
                ...
                <li><a href={`/${lng}/contact`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.links.contact')}</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-900 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href={`/${lng}/privacy`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.privacy')}</a>
              <a href={`/${lng}/terms`} className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">{t('footer.terms')}</a>
            </div>
          </div>
        </div>
      </footer>
