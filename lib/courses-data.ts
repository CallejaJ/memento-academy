...
export const freeCourses: Course[] = [
  {
    ...
    slug: "web3-basics",
    description:
      "The definitive guide to understanding the new era of the internet.",
    longDescription:
      "Learn what Web3 and blockchain are, explained simply. This comprehensive guide covers the evolution of the internet, blockchain technology, and real-world applications.",
    duration: "45 min",
    difficulty: "beginner",
    isPremium: false,
    icon: "Blocks",
    ...
    sections: [
      {
        ...
        description: "From Web 1.0 to Web 3.0",
      },
      {
        id: "blockchain",
        title: "What is Blockchain?",
        description: "The technology behind Web3",
      },
      {
        id: "applications",
        title: "Web3 Applications",
        description: "DeFi, NFTs, and more",
      },
      {
        id: "benefits",
        title: "Why Should You Care?",
        description: "Benefits and opportunities",
      },
      {
        id: "history",
      ...
      },
      {
        ...
        description: "Voting, supply chain, identity",
      },
      {
        id: "future",
        title: "Future Trends",
  ...
  },
  {
    ...
    longDescription:
      "A comprehensive introduction to cryptocurrencies, wallets, and how to safely enter the crypto world.",
    duration: "60 min",
    difficulty: "beginner",
    isPremium: false,
    icon: "Coins",
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Hot vs cold wallets",
      },
      {
        id: "security",
        title: "Key Security Concepts",
        description: "Seed phrases and private keys",
      },
      {
        id: "first-steps",
      ...
      },
      {
        ...
        description: "Exchange comparison and fees",
      },
      {
        id: "trading-basics",
      ...
      },
      {
        ...
        description: "Diversification basics",
      },
    ],
    learningOutcomes: [
  ...
  },
  {
    ...
    longDescription:
      "Discover how governments are creating their own digital currencies and what impact they'll have on your daily life.",
    duration: "40 min",
    difficulty: "beginner",
    isPremium: false,
    icon: "Landmark",
    ...
    sections: [
      {
        ...
        description: "What are CBDCs?",
      },
      {
        id: "comparison",
        title: "CBDCs vs Crypto vs Cash",
        description: "Key differences",
      },
      {
        id: "digital-euro",
        title: "The Digital Euro",
        description: "Europe's CBDC project",
      },
      {
        id: "global",
        title: "CBDCs Around the World",
        description: "China, Brazil, and more",
      },
      {
        id: "privacy",
        title: "Privacy Implications",
        description: "Surveillance concerns",
      },
      {
        id: "timeline",
  ...
  },
  {
    ...
    longDescription:
      "Learn to identify common cryptocurrency scams and implement best practices for securing your digital assets.",
    duration: "50 min",
    difficulty: "beginner",
    isPremium: false,
    icon: "Shield",
    ...
    sections: [
      {
        ...
        description: "Never share your seed phrase",
      },
      {
        id: "phishing",
        title: "Phishing Scams",
        description: "How to identify fake sites",
      },
      {
        id: "fake-support",
        title: "Fake Tech Support",
        description: "Common tactics",
      },
      {
        id: "fake-airdrops",
        title: "Fake Airdrops",
        description: "Dangerous free tokens",
      },
      {
        id: "checklist",
      ...
      },
      {
        ...
        description: "Protection options",
      },
      {
        id: "tools",
...
export const premiumCourses: Course[] = [
  {
    ...
    longDescription:
      "Go beyond the basics and learn to use DeFi protocols for lending, borrowing, yield farming, and liquidity provision.",
    duration: "90 min",
    ...
    sections: [
      {
        ...
        description: "Core concepts and protocols",
      },
      {
        id: "lending",
        title: "Lending & Borrowing",
        description: "Aave, Compound explained",
      },
      {
        id: "yield-farming",
        title: "Yield Farming",
      ...
      },
      {
        ...
        description: "AMMs and impermanent loss",
      },
      {
        id: "risks",
        title: "DeFi Risks",
        description: "Smart contract and protocol risks",
      },
      {
        id: "strategies",
        title: "DeFi Strategies",
        description: "Building your DeFi portfolio",
      },
    ],
    learningOutcomes: [
  ...
  },
  {
    ...
    longDescription:
      "From creation to trading, learn everything about NFTs including legal considerations and marketplace strategies.",
    duration: "75 min",
    difficulty: "intermediate",
    isPremium: true,
    icon: "Palette",
    ...
    sections: [
      {
        ...
        description: "What makes NFTs unique",
      },
      {
        id: "creating",
        title: "Creating NFTs",
      ...
      },
      {
        ...
        description: "OpenSea, Blur, and more",
      },
      {
        id: "valuation",
        title: "NFT Valuation",
        description: "How to assess value",
      },
      {
        id: "legal",
        title: "Legal Considerations",
        description: "Rights and royalties",
      },
    ],
    learningOutcomes: [
  ...
  },
  {
    ...
    longDescription:
      "Learn the fundamentals of smart contract development, from Solidity basics to deployment and security considerations.",
    duration: "120 min",
    difficulty: "intermediate",
    isPremium: true,
    icon: "Code",
    ...
    sections: [
      ...
      },
      {
        id: "deployment",
        title: "Deployment",
        description: "Testnets and mainnet",
      },
      {
        id: "security",
  ...
  },
  {
    ...
    longDescription:
      "Master the art of technical analysis with chart patterns, indicators, and proven trading strategies for crypto markets.",
    duration: "100 min",
    difficulty: "intermediate",
    isPremium: true,
    icon: "LineChart",
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Head & shoulders, triangles",
      },
      {
        id: "indicators",
      ...
      },
      {
        ...
        description: "Understanding market activity",
      },
      {
        id: "strategies",
      ...
      },
      {
        ...
        description: "Position sizing and stops",
      },
    ],
    learningOutcomes: [
  ...
  },
  {
    ...
    longDescription:
      "Learn professional portfolio management techniques including diversification, rebalancing, and tax optimization.",
    duration: "80 min",
    difficulty: "intermediate",
    isPremium: true,
    icon: "PieChart",
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Balancing your portfolio",
      },
      {
        id: "diversification",
  ...
  },
  {
    ...
    longDescription:
      "From frontend to smart contracts, learn to build complete dApps with modern Web3 development tools and frameworks.",
    duration: "150 min",
    difficulty: "advanced",
    isPremium: true,
    icon: "Layers",
